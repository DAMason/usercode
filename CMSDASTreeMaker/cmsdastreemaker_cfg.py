...
process.TFileService = cms.Service("TFileService",fileName = cms.string('TestTree2.root'))
...
process.tuple = cms.EDAnalyzer('CMSDASTreeMaker',
     ...
     PFCandidateThresh = cms.untracked.double(1.0),
     VertexTag = cms.untracked.string('offlinePrimaryVertices')
)


process.p = cms.Path(process.tuple)
